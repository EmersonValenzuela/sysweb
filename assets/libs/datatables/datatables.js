                    ...
                    return function(t, e, n, a) {
                        ...
                        function A(t) {
                            var e = s.defaults.oLanguage,
                                n = t.sZeroRecords;
                            !t.sEmptyTable && n && "No hay datos disponibles en la tabla" === e.sEmptyTable && le(t, t, "sZeroRecords", "sEmptyTable"), !t.sLoadingRecords && n && "Loading..." === e.sLoadingRecords && le(t, t, "sZeroRecords", "sLoadingRecords"), t.sInfoThousands && (t.sThousands = t.sInfoThousands);
                            var a = t.sDecimal;
                            a && Le(a)
                        }
                        s.util = {
                        ...
                        i("columns()", function(e, n) {
                            ...
                            iTabIndex: 0,
                            oClasses: {},
                            oLanguage: { oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" }, oPaginate: { sFirst: "First", sLast: "Last", sNext: "Siguiente", sPrevious: "Anterior" }, sEmptyTable: "No hay datos disponibles en la tabla", sInfo: "Mostrando _START_ a _END_ de _TOTAL_ registros", sInfoEmpty: "Mostrando 0 de 0 hasta 0 entradas", sInfoFiltered: "(filtered from _MAX_ total entradas)", sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "Mostar _MENU_ Registros", sLoadingRecords: "Loading...", sProcessing: "Processing...", sSearch: "Buscar:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "No matching records found" },
